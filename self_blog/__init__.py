...
try:
    VERSION = __import__("pkg_resources").get_distribution("self_blog").version
except Exception:
    VERSION = "unknown"
...
def get_revision():
    ...
    """
    if "SELF_BLOG_BUILD" in os.environ:
        return os.environ["SELF_BLOG_BUILD"]
...
def is_docker():
    ...
    # BLOG_VERSION is from a tagged release, and SELF_BLOG_BUILD is from a
    # a git based image.
    return "BLOG_VERSION" in os.environ or "SELF_BLOG_BUILD" in os.environ
